...
const photos = [
  { src: sunsetLebanon, alt: "Sunset in Lebanon", rotation: -3, size: "large", zIndex: 10 },
  { src: carryFunny, alt: "Carrying friend", rotation: 5, size: "medium", zIndex: 9 },
  { src: concertNight, alt: "Concert night", rotation: -4, size: "medium", zIndex: 8 },
  { src: barNight, alt: "Bar night", rotation: 3, size: "small", zIndex: 7 },
  { src: festivalSun, alt: "Festival in the sun", rotation: -5, size: "small", zIndex: 6 },
  { src: streetFest, alt: "Street festival", rotation: 4, size: "small", zIndex: 5 },
];
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="hidden lg:grid lg:grid-cols-5 gap-12 lg:gap-20 items-center">
          ...
          <div className="col-span-3 relative h-[600px]">
            ...
            <div 
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] h-[420px] rounded-2xl overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-[1.02] hover:shadow-3xl"
              style={{ 
            ...
            {/* Top-left photo */}
            <div 
              className="absolute left-0 top-4 w-[200px] h-[260px] rounded-xl overflow-hidden shadow-xl transition-transform duration-300 hover:scale-105"
              style={{ 
            ...
            <div 
              className="absolute -right-8 top-8 w-[180px] h-[240px] rounded-xl overflow-hidden shadow-xl transition-transform duration-300 hover:scale-105"
              style={{ 
            ...
            {/* Bottom-left photo */}
            <div 
              className="absolute left-8 bottom-0 w-[160px] h-[200px] rounded-xl overflow-hidden shadow-xl transition-transform duration-300 hover:scale-105"
              style={{ 
                transform: `rotate(-5deg)`,
                zIndex: 8 
              }}
            ...
            {/* Bottom-right photo */}
            <div 
              className="absolute right-12 bottom-8 w-[170px] h-[210px] rounded-xl overflow-hidden shadow-xl transition-transform duration-300 hover:scale-105"
              style={{ 
                transform: `rotate(4deg)`,
                zIndex: 5 
              }}
            ...
            <div 
              className="absolute right-1/4 top-0 w-[140px] h-[170px] rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105"
              style={{ 
            ...
            {/* Hidden caption */}
            <span 
              className="absolute bottom-16 left-1/2 -translate-x-1/2 text-xs text-taupe/40 font-body italic tracking-wide"
              style={{ zIndex: 20 }}
            >
        ...
        <div className="lg:hidden">
          ...
          <div 
            ref={scrollRef}
            className="flex gap-4 overflow-x-auto pb-6 -mx-6 px-6 scrollbar-hide cursor-grab active:cursor-grabbing"
          ...
          >
            {[sunsetLebanon, carryFunny, concertNight, barNight, festivalSun, streetFest].map((src, index) => (
              <div 
                key={index}
