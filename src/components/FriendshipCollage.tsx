      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="hidden lg:grid lg:grid-cols-5 gap-12 lg:gap-20 items-center">
          ...
          <div className="col-span-3 relative flex justify-center">
            <div
              className="w-[450px] h-[550px] rounded-2xl overflow-hidden shadow-2xl transition-all duration-700 hover:scale-[1.02] hover:shadow-3xl"
              style={{
            ...
            >
              <img
                src={foundersPhoto}
                alt="The founders - Habibi and Amigo"
            ...
            {/* Hidden caption */}
            <span
              className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-xs text-taupe/40 font-body italic tracking-wide"
            >
        ...
        <div className="lg:hidden">
          ...
          <div className="flex justify-center mb-6">
            <div
              className="w-full max-w-sm h-[400px] rounded-xl overflow-hidden shadow-lg"
              style={{
                transform: `rotate(-2deg)`,
              }}
            >
