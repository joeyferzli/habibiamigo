...
const featuredDesigns: Design[] = [
  ...
  },
  {
    ...
    colorVariations: [
      ...
      { name: "Lavender Blue", swatchColor: "#7b9cb8", images: [dressSpanishLavender1, dressSpanishLavender2, dressSpanishLavender3, dressSpanishLavender4, dressSpanishLavender5, dressSpanishLavender6] },
    ],
    defaultColorIndex: 0,
